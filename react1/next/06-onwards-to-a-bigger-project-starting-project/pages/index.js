...
export async function getStaticProps() {
	...
	// the 'find' method will by default find all the documents in that collection. we call 'toArray' to get back an array or documents.
	...
	return {
		props: {
			...
			meetups: meetups.map((meetup) => ({
				...
				image: meetup.image,
				// we don't need the 'description' in in the HomePage.
				id: meetup._id.toString(),
				// this will convert the '_id' from the database into a string that is usable.
			})),
			// we neet to transform the data we get from mongodb: we return an object for each meetup.
		},
		revalidate: 1,
	};
}
