...
// we do this to verify that counterReducer has run for the first time when we initialized the store (createStore).
...
// this will cause the reducer function to run again, hence the state will change, hence the counterSubscriber function will be executed.
