...
describe('class HttpError', () => {
	it('should contain the provided message, status code and data', () => {
		const testStatus = 1;
...
describe('class ValidationError', () => {
	it('should contain the provided message', () => {
		const testMessaage = 'Test';

		const testError = new ValidationError(testMessaage);

		expect(testError.message).toBe(testMessaage);
	});
});
