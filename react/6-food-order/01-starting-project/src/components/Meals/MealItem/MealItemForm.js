...
const MealItemForm = (props) => {
	...
	const submitHandler = (event) => {
		...
		// current.value is always a string, even if the input is of type number.
		...
		// in this form, we only have the amount, we don't have the id, name, price, etc. that's why we don't use the context method to add to cart here, but another function we receive through props.
	};
