...
// we are going to modify our Breath First traversal: we will only add folders to the array, not files. then, if it's a file that's contained and it ends in 'test.js', we will add that file to another array.
